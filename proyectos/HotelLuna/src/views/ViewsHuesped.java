...
public class ViewsHuesped {
    ...
    public JPanel listarHuesped() { 
        ...
        DefaultTableModel model = genery.tableModel(ctr.listOfArrayHPD(), ctr.atributeTable());
        ...
        btn_eliminar.addActionListener((e) -> {
            ...
            if(op){
                ctr.removeHuesped(tbl_table.getValueAt(row, 1).toString());
